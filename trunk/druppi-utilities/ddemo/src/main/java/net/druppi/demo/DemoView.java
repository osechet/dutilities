...
public class DemoView extends FrameView {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = DemoApplication.getApplication().getMainFrame();
            aboutBox = new DemoAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        DemoApplication.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        demoViewer = new net.druppi.demo.DemoViewer();
        ...
        mainPanel.add(demoViewer, java.awt.BorderLayout.CENTER);

        menuBar.setName("menuBar"); // NOI18N

        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(net.druppi.demo.DemoApplication.class).getContext().getResourceMap(DemoView.class);
        fileMenu.setText(resourceMap.getString("fileMenu.text")); // NOI18N
        fileMenu.setName("fileMenu"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(net.druppi.demo.DemoApplication.class).getContext().getActionMap(DemoView.class, this);
    ...
    private net.druppi.demo.DemoViewer demoViewer;
